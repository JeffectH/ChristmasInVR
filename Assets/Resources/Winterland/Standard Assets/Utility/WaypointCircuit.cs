...
namespace UnityStandardAssets.Utility
{
    public class WaypointCircuit : MonoBehaviour
    {
        ...
        public Vector3 GetRoutePosition(float dist)
        {
            ...
            // found _point numbers, now find interpolation value between the two middle points
            ...
            if (smoothRoute)
            {
                ...
                // 2nd _point may have been the 'last' _point - a dupe of the first,
        ...
        {
            // transfer the position of each _point and distances between points to arrays for
